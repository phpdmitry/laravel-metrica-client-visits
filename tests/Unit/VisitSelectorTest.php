...
final class VisitSelectorTest extends TestCase
{
    ...
    {
        $event = new VisitEvent(['occurred_at' => CarbonImmutable::parse('2026-04-28 14:32:00 UTC'), 'goal_id' => 42]);
        $candidate = new Visit(['id' => 1, 'started_at' => CarbonImmutable::parse('2026-04-28 14:31:30 UTC'), 'duration_seconds' => 120, 'goal_ids' => [41], 'goal_times' => []]);
    ...
    {
        $event = new VisitEvent(['occurred_at' => CarbonImmutable::parse('2026-04-28 14:32:00 UTC'), 'goal_id' => 42]);
        $candidate = new Visit(['id' => 1, 'started_at' => CarbonImmutable::parse('2026-04-28 14:31:30 UTC'), 'duration_seconds' => 120, 'goal_ids' => [42], 'goal_times' => ['2026-04-28T14:32:10+00:00']]);
    ...
    {
        $event = new VisitEvent(['occurred_at' => CarbonImmutable::parse('2026-04-28 14:32:00 UTC')]);
        $early = new Visit(['id' => 1, 'started_at' => CarbonImmutable::parse('2026-04-28 14:00:00 UTC'), 'duration_seconds' => 3_600]);
        $late = new Visit(['id' => 2, 'started_at' => CarbonImmutable::parse('2026-04-28 14:30:00 UTC'), 'duration_seconds' => 30]);
